export const data = `WITH
    ComprasPorGrupo AS (
        ...
        WHERE
            c.DataNota BETWEEN '2025-10-01' AND '2025-10-31'
        GROUP BY
...
FROM ComprasPorGrupo PIVOT (
        SUM(TotalCompra) FOR Grupo IN (
            [Referências e Populares], [Bonificados/Vitaminas], [Genericos], [Perfumarias], [Conveniencias], [OUTROS]
        )
    ) AS p
ORDER BY Dia;`;
